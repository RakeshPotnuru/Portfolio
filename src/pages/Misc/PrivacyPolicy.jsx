  ...
  return (
    <Container>
      ...
      <p>
        ...
        contains types of information that is collected and recorded by Its
        Rakesh and how we use it.
      </p>
      ...
      <p>
        Its Rakesh follows a standard procedure of using log files. These files
      ...
      <p>
        Note that Its Rakesh has no access to or control over these cookies that
